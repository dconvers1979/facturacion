...
import com.firefly.product.facturacion.negocio.entities.Cargos;
import com.firefly.product.facturacion.negocio.session.CargosFacade;
...
public class CargosController implements Serializable {
    ...
    @EJB
    private CargosFacade ejbFacade;
    ...
    public static class CargosControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Cargos) {
                ...
                return getStringKey(o.getIdcargos());
            } else {
